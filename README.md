![header](https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=200&section=header&text=Alex%20%7C%20CV/AI%20Engineer&fontSize=36&fontColor=fff&animation=twinkling&fontAlignY=35)
...
I'm a **Computer Vision / AI Engineer** who builds intelligent visual perception systems. 🚀
From object detection to segmentation, tracking to model optimization — I cover the full CV pipeline.

I love turning cutting-edge research papers into real-world production models. 🔬➡️🏭
...
![Qwen--VL](https://img.shields.io/badge/Qwen--VL-7C3AED?style=flat-square&logoColor=white)
